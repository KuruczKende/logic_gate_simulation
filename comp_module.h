...
class comp_module_t : public shell_module_t {
    ...
    void compCreateModules(bool copy, lista<size_t>& vegk, lista<size_t>& kezk, lista<prot_module_t*>* protModules, module_t**const moduleRef);
...
public:
    ...
    trilean getKiErtek(size_t i) const {return endModule.getKiErtek(i);}
    size_t getKiNum() const {return endModule.getKiNum();}
    ~comp_module_t();
};
#endif
